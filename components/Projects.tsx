...
const Projects = () => {
  ...
  return (
    <div className="px-2" id="projects">
      <div className="bg-sky-800 py-16 flex flex-col items-center justify-center rounded-xl">
        <h1 className="font-serif font-bold text-xl md:text-3xl text-white flex flex-col md:flex-row gap-4 mb-5">
          My Projects
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-center px-4">
          {projects
            ...
            .map((project, index) => (
              ...
              >
                <Card
                  className="max-w-sm shadow-lg border-sky-900 rounded-lg md:h-[26rem] relative"
                  renderImage={() => (
                    <Image
                      width={500}
                      height={500}
                ...
                >
                  <div className="flex flex-col h-full justify-between">
                    ...
                    <ul className="flex gap-2 text-gray-200 py-2 mx-auto items-center">
